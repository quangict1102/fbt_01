...
<!-- //Custom Theme files -->
<link href="../../src/main/webapp/assets/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
<link href="../../asets/css/style.css" type="text/css" rel="stylesheet" media="all">
