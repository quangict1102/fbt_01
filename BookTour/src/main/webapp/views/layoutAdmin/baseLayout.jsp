...
<spring:url value="/assets/vendor/bootstrap/css/bootstrap.min.css"
	var="bootstrapCss" />
<spring:url value="/assets/vendor/fontawesome-free/css/all.min.css"
	var="allCss" />
<spring:url value="/assets/vendor/datatables/dataTables.bootstrap4.css"
	var="bootstrap4Css" />
...
<body>
	...
	<spring:url value="/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"
		var="bootstrapBundleJs" />
	<spring:url value="/assets/vendor/jquery-easing/jquery.easing.min.js"
		var="bootstrapEasingJs" />
	<spring:url value="/assets/vendor/chart.js/Chart.min.js" var="chartJs" />
	<spring:url value="/assets/vendor/datatables/jquery.dataTables.js"
		var="dataTablesJs" />
	<spring:url value="/assets/vendor/datatables/dataTables.bootstrap4.js"
		var="bootstrap4Js" />
	<spring:url value="/assets/js/adminJs/sb-admin.min.js" var="adminJs" />
	<spring:url value="/assets/js/adminJs/datatables-demo.js"
		var="dataTableDemoJs" />
